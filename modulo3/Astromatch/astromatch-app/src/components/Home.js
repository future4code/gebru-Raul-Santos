...
import { MySwal } from './clear'
import Logo from '../img/icon.png'
import Chat from '../img/user.png'
import Heart from '../img/Positivo.png'
import Cross from '../img/Negativo.png'
import Star from '../img/favorito.png'
